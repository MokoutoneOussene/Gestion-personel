                                    ...
                                    <div class="sbp-preview-content">
                                        <form method="POST" action="{{ route('gestion_mission.store') }}"
                                            ...
                                            <div class="p-2 m-1"
                                                ...
                                                <h3 class="m-2 text-center text-danger">Créer et programmer une mission</h3>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            <label>Code de la mission</label>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text" name="lib" required />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                ...
                                                <!-- Bouton pour ajouter plus de personnel -->
                                                <div class="mt-3 text-center">
                                                    <button type="button" class="btn btn-info"
                                                        id="add-personnel">Ajouter plus de personnel</button>
                                                </div>
